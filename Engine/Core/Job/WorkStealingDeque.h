...
namespace fang
{
	 ...
	 * @details Chase–Lev の deque。メモリオーダーは弱いメモリモデル向けの版に合わせてある。
...
#pragma warning(disable : 4324)
	...
	public:
		...
		[[nodiscard]] bool Push(const TValue& value)
		{
			...
			// 中身の書き込みを bottom の公開より前に見えさせる。
			// これが無いと、奪う側が進んだ bottom を見た後で古い中身を読める。
	...
	private:
		...
		// 符号付きなのは、空のときの Pop で bottom が一時的に −1 になるため。
		// 符号なしだと巻き戻って「空でない」と判断してしまう。
